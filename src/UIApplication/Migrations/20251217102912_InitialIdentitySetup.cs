    ...
    public partial class InitialIdentitySetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PromptsUsed = table.Column<int>(type: "int", nullable: false),
                    StocksAnalyzed = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyIndicators = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserPromptId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockAnalyses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockAnalyses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAnalyses_UserPromptId",
                table: "StockAnalyses",
                column: "UserPromptId");
